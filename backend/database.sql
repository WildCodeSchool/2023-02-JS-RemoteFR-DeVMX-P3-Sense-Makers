...
VALUES ("Administrateur"), ("Salarié"), ("Expert");

INSERT INTO `status` (title)
VALUES ("Prise de décision débutée"), ("Première décision prise"), ("Conflit sur la décision"), ("Décision définitive"), ("Décision non aboutie"), ("Décision terminée");
...
VALUES (1, 1), (1, 3), (2, 2), (3, 2), (4, 2), (4, 3);

INSERT INTO
    users_decisions (user_id, decision_id)
VALUES (2, 1), (3, 2), (1, 4), (4, 3), (1, 5), (1, 6);

INSERT INTO
    tagged_as_experts (user_id, decision_id)
VALUES (1, 1), (1, 3), (4, 4), (4, 2), (1, 4), (4, 3), (4, 5), (4, 6);

INSERT INTO
    tagged_as_impacted (user_id, decision_id)
VALUES (2, 1), (3, 1), (2, 2), (3, 2), (3, 3), (2, 3), (3, 4), (2, 4), (4, 5), (2, 6);
