...
CREATE TABLE decisions (
  ...
  initial_date TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
  first_take_decision TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
  final_take_decision TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
  positives_votes INT,
  negatives_votes INT,
